...
const friendRequestStatus_entity_1 = require("./friendRequestStatus.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => friendRequestStatus_entity_1.FriendRequestStatus, { eager: true }),
